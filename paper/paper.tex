...
$b(n)=n!\coeff{n}\big(F^{n}\exp(xG^{n})\big)$ satisfies \eqref{eq:scp}.
\end{corollary}
\begin{proof}
...
$1, 2, 11, 124, 2225, 56546, 1928707, 85029596, 4687436609$. Modulo $7$ it is
$1,2,4,5,6,0,4,1,2,\dots$, of period $7$, as \eqref{eq:scp} requires.
\end{example}
...
\begin{itemize}[nosep]
  ...
  \item \texttt{bala\_congruence}: \Cref{thm:main}; and named corollaries
        \texttt{bala\_congruence\_A361036}, \texttt{\_A278070}, \texttt{\_A361281},
        \texttt{\_A293013}.
\end{itemize}
